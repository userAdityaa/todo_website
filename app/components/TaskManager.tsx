...
const TaskManager: React.FC<TaskManagerProps> = ({ taskName, onClose, taskId }) => {
  ...
  return (
    <div className={`absolute right-5 bg-zinc-100 rounded-xl h-[95vh] w-[40vh] p-4 ${public_sans.className}`}>
        <div className='flex flex-col'>
            ...
            <textarea 
              ...
              className="mt-4 p-2 border rounded-lg h-32"
            />
            ...
            <div className='flex justify-between mt-[12.5rem]'>
              <button 
