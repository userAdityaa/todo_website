...
export default function Home() {
  return (
    <div className={`bg-white flex items-center justify-center h-[100vh] w-[100vw] ${shanti.className} font-bold`}>
      ...
      <div className="w-[50%] h-full bg-black flex items-center justify-center rounded-2xl">
      ...
      <div className="w-[50%] h-full flex items-center justify-center">
        <div className="w-[60%] h-[40%] flex flex-col gap-4">
          ...
          <p className="text-zinc-700 text-center">Already have an account? <span>Sign in</span></p>
        </div>
      </div>
    </div>
  );
